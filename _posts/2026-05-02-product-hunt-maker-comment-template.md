---
layout: post
title: "Product Hunt Maker Comment Template (6 Variants from 30x #1 Winner)"
...
canonical_url: https://tools.gingiris.com/blog/2026/05/02/product-hunt-maker-comment-template/
...
faq:
  - q: "What should I write in my Product Hunt maker comment?"
    a: "Open with a 1-sentence founder story (why you built it), then 3 bullets of what's actually new, then 1 specific ask (feedback question, not 'please upvote'). Across 30 PH #1 launches, this structure drove ~68% read-through (vs ~22% for feature-list openers) and 2.4x reply rate vs comments without a founder story."
  - q: "How long should a Product Hunt first comment be?"
    a: "150-280 words is the sweet spot. Under 100 words reads as low effort; over 350 words gets truncated by PH's 'show more' fold and read-through drops below 30%. Aim for 4-6 short paragraphs that fit on one mobile screen."
  - q: "When should I post the maker comment on launch day?"
    a: "Within the first 5 minutes after the product goes live (12:01 AM PST). PH's algorithm in 2026 weights early-comment velocity ~3x more than late comments. The first hour of comments anchors the conversation tone for the remaining 23 hours."
  - q: "Should I include a link in my Product Hunt maker comment?"
    a: "One link maximum, and it should be a Loom video or interactive demo — not a marketing page. Comments with 2+ external links get visibility-throttled by PH's spam heuristic. The product page itself already has all the links a viewer needs."
  - q: "What's the difference between a maker comment and a hunter comment?"
    a: "The hunter comment frames the product for a cold audience ('here's why this matters'). The maker comment is your founder voice ('here's why I built it and what's broken about the alternatives'). Both should appear within the first 10 minutes of the launch — coordinate with your hunter the night before."
---
...
1. **Hunter comment** (posted by the hunter) — frames product for cold visitors
2. **Maker comment** (this post) — founder voice + the why
3. **First reply from a real user** — earned via [LinkedIn DM outreach]({{ "/blog/2026/04/26/product-hunt-linkedin-dm-template/" | relative_url }}) over the prior 4 weeks
...
- **[Launch day timeline (hour-by-hour PST)]({{ "/blog/2026/03/25/product-hunt-launch-playbook-the-definitive-guide-30x-1-winner/" | relative_url }})** — the full 24-hour PST action map; this maker comment goes live at the 00:05 PST slot
...
*Written by [Iris](https://gingiris.com) — ex-AFFiNE COO, 60k+ GitHub stars, 30x Product Hunt #1 winner. Last updated: 2026-05-02.*
