# Deploy growth-tools to gingiris.tools

> Migrated from `gingiris.tools` (404'd after GitHub spam-flag) to independent Cloudflare Pages deploy at `gingiris.tools`.
...
6. Once green: **Custom domains** → Set up → enter `gingiris.tools`
